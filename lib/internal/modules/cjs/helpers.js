...
function makeRequireFunction(mod, redirects) {
  ...
  if (redirects) {
    ...
    require = function require(specifier) {
      ...
      const baseFilePath = fileURLToPath(redirects.baseURL);
      const proxy = new Module(baseFilePath, null);
      proxy.filename = baseFilePath;
      return makeRequireFunction(proxy, null)(specifier);
    };
  } else {
